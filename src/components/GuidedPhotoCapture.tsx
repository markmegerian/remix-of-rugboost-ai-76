    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div
          ...
          aria-valuemin={1}
          aria-valuemax={totalRequiredSteps}
          aria-label={captureMode === 'guided' ? `Step ${currentStep + 1} of ${totalRequiredSteps}: ${PHOTO_STEPS[currentStep].title}` : `${completedRequiredSteps} of ${totalRequiredSteps} required photos captured`}
        >
