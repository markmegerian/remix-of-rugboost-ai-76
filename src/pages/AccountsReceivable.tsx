      ...
      <header className="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-md">
        <div className="container mx-auto flex items-center justify-between px-4 py-2.5 md:py-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <h1 className="font-display text-lg md:text-xl font-bold text-foreground">Accounts Receivable</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">Payments by Job</p>
            </div>
          </div>
